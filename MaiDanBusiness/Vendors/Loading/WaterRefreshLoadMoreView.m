...
@property (nonatomic, retain) SRSlimeView *slime;
@property (nonatomic, retain) UIActivityIndicatorView *loadMoreActivityView;
...
@property (nonatomic, retain) NSString *refreshRemindWord;
@property (nonatomic, retain) NSString *loadMoreRemindWord;
