...
// 水下拉的view
@property (nonatomic, retain) UIView *waterRefreshView;
// 上拉的view
@property (nonatomic, retain) UIView *loadMoreView;

// 水滴中央的图片样式
@property (nonatomic, retain) UIImageView *refleshView;
// 刷新提示字时 前方显示的 图片样式
@property (nonatomic, retain) UIImageView *refreshRemindPicView;

// refresh上的提示label
@property (nonatomic, retain) UILabel *refreshRemind;
// loadMore上的提示label
@property (nonatomic, retain) UILabel *loadMoreRemind;

// loadMore转圈时显示的文字，比如 "加载中.."，没有设置则转动图样居中显示
@property (nonatomic, retain) NSString *loadMoreIndicatorWord;

@property (nonatomic, retain) id <WaterRefreshDelegate>   refreshDelegate;
@property (nonatomic, retain) id <WaterLoadMoreDelegate>  loadMoreDelegate;
