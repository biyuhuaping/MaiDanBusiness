...
#define left_width (self.frame.size.width*2.0/16.0)

#define sacnRect_width (self.frame.size.width*12.0/16.0)
#define sacnRect_height (self.frame.size.width*12.0/16.0)

#define top_height ((self.frame.size.height-sacnRect_height)/2-70)
#define bottom_height (self.frame.size.height - top_height - sacnRect_height)

#define back_color [UIColor colorWithRed:0 green:0 blue:0 alpha:0.8]
...
-(void)createYellowHLineWithX:(float)X withY:(float)Y
{
    ...
    line.backgroundColor = RGBCOLOR(237, 87, 49);
